...
WALL_EDGE_WIDTH = 1.6
OPENING_FILL = "#5b5f66" # dark grey block, like the sketch
FLOOR_FILL = "#f4f5f8"
TEXT_COLOR = "#1c2b4a"
...
# --------------------------------------------------------------------------- #
# Demo: reproduces the "Atelier - dépôt / Citerne / Garage" sketch.
# Run `python floorplan.py` to generate demo.png.
# --------------------------------------------------------------------------- #
